...
function Add({ closeModal, addProduct, lastProductId }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
      <div className="bg-white w-[90%] sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[40%] max-h-[90vh] overflow-y-auto p-6 rounded-md shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="border p-4 rounded-md flex flex-col items-center">
            ...
            {image && (
              <img src={image} alt="Uploaded Preview" className="w-full max-w-xs h-auto object-cover rounded-md mt-2" />
            )}
          </div>
          <input
            className="w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-400 outline-none"
